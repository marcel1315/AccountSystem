...
class TransactionServiceTest {
    ...
    void successUseBalance() {
        ...
        //when
        TransactionDto transactionDto = transactionService.useBalance(1L, "100000000", 200L);
    ...
    void useBalance_UserNotFound() {
        ...
        //when
        AccountException exception = assertThrows(AccountException.class, () -> transactionService.useBalance(1L, "100000000", 1000L));
    ...
    void deleteAccountFailed_userUnMatch() {
        ...
        given(accountRepository.findByAccountNumber(anyString()))
                .willReturn(Optional.of(Account.builder()
                        ...
                        .build()));
        //when
        AccountException exception = assertThrows(AccountException.class, () -> transactionService.useBalance(1L, "1000000000", 10000L));
    ...
    void deleteAccountFailed_alreadyUnregistered() {
        ...
        given(accountRepository.findByAccountNumber(anyString()))
                .willReturn(Optional.of(Account.builder()
                        ...
                        .build()));
        //when
        AccountException exception = assertThrows(AccountException.class, () -> transactionService.useBalance(1L, "1234567890", 10000L));
    ...
    void successCancelBalance() {
        ...
        //when
        TransactionDto transactionDto = transactionService.cancelBalance("transactionId", "100000000", CANCEL_AMOUNT);
    ...
    @Test
    @DisplayName("거래 취소는 최대한 1년까지만 가능 - 잔액 사용 취소 실패")
    ...
    void successQueryTransaction() {
        ...
        assertEquals(S, transactionDto.getTransactionResultType());
        assertEquals(CANCEL_AMOUNT, transactionDto.getAmount());
        assertEquals("transactionId", transactionDto.getTransactedId());
    }
